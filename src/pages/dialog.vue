            ...
            <q-card>
                ...
                <q-card-section class="q-pt-none" style="width: 550px; height: 25vh">
                    ...
                    <div class="aa" style="display: flex">
                        <!-- <q-item v-for="n in [1,2,3]" :key="n" >
                        <q-checkbox v-model="selection" val="teal" label="Teal" color="teal" />  -->
                        <!-- </q-item> -->
                        <q-checkbox v-model="selection" val="teal" label="Fp1-A1" color="teal" />
                        <q-checkbox v-model="selection" val="teal1" label="F3-A1" color="teal" />
                        <q-checkbox v-model="selection" val="teal2" label="C3-A1" color="teal" />
                        <q-checkbox v-model="selection" val="teal3" label="O1-A1" color="teal" />
                        <!-- <q-checkbox v-model="selection" val="teal" label="Fp2-A2" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="Fp4-A4" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="O2-A2" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="F7-A1" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="T3-A1" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="T5-A1" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="F8-A2" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="T4-A2" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="T6-A2" color="teal" />
                        <q-checkbox v-model="selection" val="teal" label="ECG" color="teal" />  -->
                    </div>
